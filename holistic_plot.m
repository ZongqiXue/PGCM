function [r R0 R1 R2]=holistic_plot(bsgi,bsfit,xx_2,yy_2,zz_2,xx_3,yy_3,zz_3,xub,xlb,yub,ylb)
num=325;
x=bsgi(:,2);
y=bsgi(:,3);
axis equal
...
for i=1:num
    if m(i)==0
        pb=patch((r*sin(angle)+ x(i)),(r*cos(angle)+y(i)),[0.3 0.3 1],'facealpha',0.3,'edgecolor','k');
        %alpha(pb,.3);
    end
    hold on  
end
